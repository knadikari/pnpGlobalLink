...
class RecoverDaemon:
    ...
    def getNextScans(self):
        if(self.myreqjson is None or self.myseqjson is None):
            ...
            successip=None
            successPort=None
            nextList, self.myreqjson, handle, reply, successip, successPort = nodeFind.finder(self.myreqjson, handle, reply,
                                                                                       successip, successPort)
            nextList, self.myreqjson, handle, reply, successip, successPort
            ...
            if(self.getNoOfnodes(self.myseqjson)==self.getNoOfnodes(finalReply)):
                cprint('LAMO', 'green')
                self.submitData(reply, successip, successPort)
    ...
    def submitData(self,reply,successip,successPort):
